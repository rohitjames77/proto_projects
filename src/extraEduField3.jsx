 export default function ExtraEducationField3({ educationInfo, setEducationInfo }) {
  ...
  return (
    <div className="grid grid-rows-6 grid-cols-4 gap-y-6 m-4 mt-5 border-b-4 border-gray-400 pb-8 ">
      ...
      <input
        type="text"
        className="bg-gray-200 text-gray-800 rounded-xl row-start-1 col-start-2 col-end-5"
        id="school3"
      ...
      <input
        type="date"
        className="bg-gray-200 text-gray-800 rounded-xl row-start-4 col-start-2 col-end-5"
        id="startDate3"
      ...
      <input
        type="date"
        className="bg-gray-200 text-gray-800 rounded-xl row-start-5 col-start-2 col-end-5"
        id="endDate3"
